...
public class AutoRedWarehouse extends LinearOpMode
{
    ...
    public void runCaught() throws InterruptedException {
        ...
        TrajectorySequence seq2 = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(Constants.redWarehouseStartingPoseX, Constants.redWarehouseStartingPoseY + 6, Math.toRadians(0))) // In line with shipping hub
                .lineToLinearHeading(new Pose2d(Constants.redWarehouseStartingPoseX + 3 * 12, Constants.redWarehouseStartingPoseY + 6, Math.toRadians(0)))
                .build();
